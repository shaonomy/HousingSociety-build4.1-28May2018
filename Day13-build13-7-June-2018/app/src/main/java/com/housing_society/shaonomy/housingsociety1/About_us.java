...
public class About_us extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(About_us.this);
...
//        });
    ...
    private void jsonParse(){
        ...
        String url = "http://192.168.1.60/otp/memberdetails.php";
        pd.show();
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            JSONArray jsonArray = response.getJSONArray("comp_data");
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                result.append("Commitee member designation:" + username + ", " + "  " + "Name:" + passwd + ", " + "  " + "Contact:" + phone + "\n\n");
