...
public class FeaturesServices extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardView[0]=(CardView) findViewById(R.id.card_view);
        cardView[0].setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                onCardPressed(cardView[0]);
            }
        });

        cardView[1]=(CardView) findViewById(R.id.card_view1);
        cardView[1].setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                onCardPressed(cardView[1]);
            }
        });

        cardView[2]=(CardView) findViewById(R.id.card_view2);
        cardView[2].setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                onCardPressed(cardView[2]);
            }
        });

        cardView[3]=(CardView) findViewById(R.id.card_view3);
        cardView[3].setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                onCardPressed(cardView[3]);
            }
        });

        cardView[4]=(CardView) findViewById(R.id.card_view3);
        cardView[4].setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                onCardPressed(cardView[4]);
            }
        });
//        cardView[1]=(CardView) findViewById(R.id.card_view);
//        cardView[2]=(CardView) findViewById(R.id.card_view);
//        cardView[3]=(CardView) findViewById(R.id.card_view);
//        cardView[4]=(CardView) findViewById(R.id.card_view);


    }

    public void onCardPressed(CardView cardview){
        intent = new Intent(FeaturesServices.this,FeaturesServices2.class);
        ...
        switch(id) {
            ...
            case R.id.nav1_paymentdetails:
               ...
               case R.id.nav1_events:
                intent= new Intent(FeaturesServices.this,Events.class);
                startActivity(intent);
                this.finish();
                break;
